...
public static async Task<IActionResult> Run(HttpRequest req, ILogger log)
{
    ...
    {
        conn.Open();
        var sqlQuery ="SELECT TOP "+ amount.ToString() +" * FROM (SELECT TOP 100 PERCENT * FROM ScoresApp WHERE Name='"+bname+"' ORDER BY Date DESC) AS B ORDER BY Date DESC FOR JSON PATH;";
