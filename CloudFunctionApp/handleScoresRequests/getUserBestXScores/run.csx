...
public static async Task<IActionResult> Run(HttpRequest req, ILogger log)
{
    ...
    {
        conn.Open();
        var sqlQuery ="SELECT TOP "+ amount.ToString() +" * FROM (SELECT TOP 100 PERCENT * FROM Scores WHERE Name='"+bname+"' ORDER BY Date ASC) AS B ORDER BY Date ASC FOR JSON PATH;";
