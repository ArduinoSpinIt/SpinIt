   ...
   public class CustomCell : ViewCell
    {
        ...
        /*public CustomCell(string date_,string time_, string distance_)
        {
            ...
            date.TextColor = Color.FromHex("#f35e20");
            time.TextColor = Color.FromHex("#f35e20");
            distance.TextColor = Color.FromHex("#f35e20");
            //values initializing
            image.Source = "wheel_small.png";
            distance.Text = distance_;
            time.Text = time_;
            date.Text = date_;
